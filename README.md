...
Последняя завершённая версия: `0.024`.
...
- космический фундамент впервые подключён к игре напрямую: звезда стала реальным источником света, введён базовый `day/night`, а локальный voxel-world получил первый `planet frame` вокруг активной планеты;
